...
namespace HogentVmPortal.Migrations
{
    ...
    [Migration("20240417071220_SshKeyForEdit")]
    partial class SshKeyForEdit
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CourseTemplate", b =>
                {
                    b.Property<Guid>("CoursesId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasKey("CoursesId", "TemplatesId");
            ...
            modelBuilder.Entity("HogentVmPortal.Shared.Model.Template", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("HogentVmPortal.Shared.Model.VirtualMachineCreateRequest", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("HogentVmPortal.Shared.Model.VirtualMachineEditRequest", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("VirtualMachineEditRequest", (string)null);
                });

            modelBuilder.Entity("HogentVmPortal.Shared.Model.VirtualMachineRemoveRequest", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("CourseTemplate", b =>
                {
                    ...
                    b.HasOne("HogentVmPortal.Shared.Model.Template", null)
                        .WithMany()
            ...
            modelBuilder.Entity("HogentVmPortal.Shared.Model.VirtualMachine", b =>
                {
                    ...
                    b.HasOne("HogentVmPortal.Shared.Model.Template", "Template")
                        .WithMany("VirtualMachines")
